...
public class Extractor {
            ...
            if (!Regex.INVALID_MENTION_MATCH_END.matcher(after).find()) {
                if (matcher.group(Regex.VALID_MENTION_OR_LIST_GROUP_LIST) == null) {
                    ...
                    extracted.add(new Entity(matcher.start(Regex.VALID_MENTION_OR_LIST_GROUP_USERNAME) - 1,
                            matcher.end(Regex.VALID_MENTION_OR_LIST_GROUP_LIST), matcher.group(Regex.VALID_MENTION_OR_LIST_GROUP_USERNAME), matcher
    ...
    /**
     * Extract a @username reference from the beginning of Tweet text. A reply is an occurance of @username at the beginning of a Tweet, preceded by 0 or more
     * spaces.
     * 
     * @param text
    ...
    /*
     * Modify Unicode-based indices of the entities to UTF-16 based indices. In UTF-16 based indices, Unicode supplementary characters are counted as two
     * characters. This method requires that the list of entities be in ascending order by start index.
    ...
    /*
     * Modify UTF-16-based indices of the entities to Unicode-based indices. In Unicode-based indices, Unicode supplementary characters are counted as single
     * characters. This method requires that the list of entities be in ascending order by start index.
     * @param text original text
