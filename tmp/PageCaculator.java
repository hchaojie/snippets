...
public class PageCaculator {
	...
	public PageCaculator(int pageWidth, int pageHeigh) {
	...
	/**
	 * calculate start and end point by corner point and control point
	 * 
	 * Corner.x - Control.x = 2 * (Control.x - Start.x)
	 * 
	 * @return PointF[] {left, right}
	 */
	public static PointF[] getStartAndEndPoint(PointF pCorner, PointF pCtrls[]) {
